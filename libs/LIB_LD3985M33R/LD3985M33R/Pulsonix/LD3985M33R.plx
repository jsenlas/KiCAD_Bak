...
//2223/412237/2.48/5/3/Integrated Circuit
...
(library Library_1
	...
	(compDef "LD3985M33R" (originalName "LD3985M33R") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		...
		(compPin "3" (pinName "INHIBIT") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/STMicroelectronics/LD3985M33R/?qs=22WmWNTp1rrPOccVv4HZ7A%3D%3D")
		(attr "Arrow Part Number" "LD3985M33R")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/ld3985m33r/stmicroelectronics")
